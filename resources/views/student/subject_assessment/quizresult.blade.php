                            ...
                            <div class="card-body">
                                ...
                                <div class="row mt-4">
                                    <div class="col-md-12">
                                        ...
                                        <a id="done-btn" href="/student/quiz/{{ Session::get('subjects')->id }}/{{ $data['quizid'] }}" class="btn btn-success pull-right" hidden>Done</a>
                                    </div>
                                </div>
                            </div>
                        </div>
