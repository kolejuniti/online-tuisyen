                                ...
                                <td class="project-actions text-center" >
                                  @if (empty($status[$key]) || ($status[$key]->status == 1) )
                                    @if ($qz->status == 2)
                                      ...
                                      <a class="btn btn-success btn-sm mr-2" href="/student/test/{{ Session::get('subjects')->id }}/{{ request()->test }}/view">
                                        <i class="ti-user">
                                        </i>
                                        Answer
                                      </a>
                                    ...
                                    @endif
                                  @elseif (!($status[$key]))
                                  <a class="btn btn-success btn-sm mr-2" href="/student/test/{{ request()->test }}/{{ Auth::guard('student')->user()->ic }}/result">
                                    <i class="ti-user">
                                    </i>
                                    Result
                                  </a>
