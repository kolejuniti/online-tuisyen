                ...
                <div class="col-xl-12 col-12">
                    <div class="box">
                        <div class="box-header">
                            <h4 class="box-title">Available Materials</h4>
                        </div>
                        <div class="box-body">
                            <div id="material-div">                    
                                <div id="material-directory" class="row">
                                    ...
                                    <div class="col-md-3 col-sm-6 mb-4">
                                        <div class="material-card back-folder">
                                            <a href="/student/content/material/prev/{{ $prev }}" class="text-decoration-none d-block">
                                    ...
                                    <div class="col-md-3 col-sm-6 mb-4">
                                        <div class="material-card position-relative">
                                            ...
                                            <a href="/student/content/material/sub/content/{{ $fold->DrID }}" class="text-decoration-none d-block">
                                                <div class="text-center p-4">
                                                    <div class="folder-icon-container">
                                                        <div class="icon-background folder-icon-background">
                                                            <svg class="folder-icon" width="80" height="80" viewBox="0 0 309.27 309.27">
                                    ...
                                    @if($url != null)
                                        @foreach($url as $key => $ul)
                                            @php
                                                ...
                                                // Google Meet: cannot be embedded; open in new tab
