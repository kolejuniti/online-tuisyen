            ...
            <div class="row">
                <div class="col-xl-12 col-12">
                    <div class="box">
                        ...
                        <div class="box-body">
                            <div id="material-div">
                                <form action="/user/content/material/sub/content/upload/{{ $dirid }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div id="material-directory" class="row">
                                        ...
                                        <div class="col-md-3 col-sm-6 mb-4">
                                            <div class="material-card back-folder material-card-visible" style="opacity: 1; transform: translateY(0); background-color: white; box-shadow: 0 10px 25px rgba(0,0,0,0.1); border-radius: 16px; overflow: hidden; border: none;">
                                                <a href="/user/content/material/sub/prev/{{ $prev }}" class="text-decoration-none d-block">
                                        ...
                                        <div class="col-md-3 col-sm-6 mb-4">
                                            <div class="material-card position-relative material-card-visible" style="opacity: 1; transform: translateY(0); background-color: white; box-shadow: 0 10px 25px rgba(0,0,0,0.1); border-radius: 16px; overflow: hidden; border: none;">
                                                ...
                                                <div class="rename-container px-3 pb-3"> 
                                                ...
                                                <div class="content-actions">
                                                    ...
                                                    <button type="button" onclick="deleteMaterial('{{ $mats }}')" 
...
<div class="modal fade" id="uploadLink" tabindex="-1" aria-labelledby="uploadLinkLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <form action="/user/content/material/sub/content/upload/{{ $dirid }}" method="post" role="form" enctype="multipart/form-data">
                @csrf
                @method('POST')
                <div class="modal-header">
...
<script type="text/javascript">
        ...
        Swal.fire({
            ...
            if (res.isConfirmed) {
                ...
                $.ajax({
                    ...
                    url: "{{ url('user/content/folder/subfolder/material/delete') }}",
                    method: 'DELETE',
                    data: {mats: mats},
                    error: function(err) {
                        Swal.fire({
    ...
    function renameFile(file, key, ext) {
        ...
        $.ajax({
            headers: {'X-CSRF-TOKEN':  $('meta[name="csrf-token"]').attr('content')},
            url: "{{ url('user/content/folder/subfolder/material/renameFile') }}",
            method: 'POST',
