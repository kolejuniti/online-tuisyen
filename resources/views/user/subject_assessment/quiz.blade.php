                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td class="project-actions text-right" >
                                <a class="btn btn-success btn-sm mr-2" href="/user/quiz/{{ Session::get('subjects')->id }}/{{ $dt->id }}">
                                    <i class="ti-user">
                                    </i>
                                    Students
                                </a>
                                <a class="btn btn-info btn-sm btn-sm mr-2" href="/user/quiz/{{ Session::get('subjects')->id }}/create?quizid={{ $dt->id }}">
...
$(document).ready( function () {
    ...
    $(document).on('click', '#newFolder', function() {
        location.href = "/user/quiz/{{ Session::get('subjects')->id }}/create";
    })
