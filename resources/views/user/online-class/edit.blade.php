    ...
    <div class="container-full">
        ...
        <div class="content-header">
            <div class="d-flex align-items-center">
                <div class="me-auto">
                    <h4 class="page-title">Edit Online Class</h4>
                ...
                <div class="col-12">
                    <div class="box">
                        <div class="box-header with-border">
                            <h3 class="box-title">Edit Online Class: {{ $onlineClass->name }}</h3>
                        ...
                        <div class="box-body">
                            ...
                            <form action="{{ route('user.online-class.update', [$course->id ?? Session::get('subjects')->id, $onlineClass->id]) }}" 
                                  method="POST" id="editClassForm">
                                @csrf
                                @method('PUT')
                                            ...
                                            <div class="card-body">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" 
                                                           ...
                                                           id="name" 
                                                           name="name" 
                                                           value="{{ old('name', $onlineClass->name) }}" 
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="datetime-local" 
                                                           ...
                                                           id="datetime" 
                                                           name="datetime" 
                                                           value="{{ old('datetime', $onlineClass->datetime->format('Y-m-d\TH:i')) }}" 
                                                           required>
                                                    @error('datetime')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control @error('status') is-invalid @enderror" 
                                                            ...
                                                            name="status" 
                                                            required>
                                                        <option value="active" {{ old('status', $onlineClass->status) == 'active' ? 'selected' : '' }}>Active</option>
                                                        <option value="inactive" {{ old('status', $onlineClass->status) == 'inactive' ? 'selected' : '' }}>Inactive</option>
                                                    </select>
                                                    @error('status')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                        ...
                                                        @foreach($schools as $school)
                                                            <div class="form-check mb-2">
                                                                <input class="form-check-input school-checkbox" 
                                                                       ...
                                                                       name="schools[]"
                                                                       {{ in_array($school->id, old('schools', $selectedSchools)) ? 'checked' : '' }}
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            <button type="submit" class="btn btn-primary">
                                                <i class="fa fa-save"></i> Update Online Class
                                            </button>
                                            <a href="{{ route('user.online-class.index', $course->id ?? Session::get('subjects')->id) }}" 
