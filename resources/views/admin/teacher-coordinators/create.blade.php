...
@section('title', 'Add Teacher Coordinator')
    ...
    <div class="container-full">
        ...
        <div class="content-header">
            <div class="d-flex align-items-center">
                <div class="me-auto">
                    <h3 class="page-title">Add Teacher Coordinator</h3>
                ...
                <div class="col-12">
                    ...
                    <div class="box">
                        <div class="box-header with-border">
                            <h4 class="box-title">Teacher Coordinator Information</h4>
                            <p class="text-muted">Add a new teacher coordinator to manage a school. Each school can only have one coordinator.</p>
                        </div>
                        <div class="box-body">
                            @if($schools->isEmpty())
                                <div class="alert alert-warning">
                                    <i class="fa fa-exclamation-triangle"></i>
                                    <strong>No Available Schools</strong><br>
                                    All schools already have teacher coordinators assigned, or no schools exist in the system.
                                    <br><br>
                            ...
                            @else
                                <form action="{{ route('admin.teacher-coordinators.store') }}" method="POST" id="coordinatorForm">
                                    @csrf
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <small class="text-muted">Only schools without coordinators are shown.</small>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="alert alert-info">
                                        ...
                                        <strong>Note:</strong> A unique secret code will be automatically generated for this coordinator. This code can be used for authentication and access control.
                                    </div>
                                    ...
                                    <div class="form-group text-end">
                                        ...
                                        <button type="submit" class="btn btn-success">
                                            <i class="fa fa-save"></i> Create Coordinator
                                        </button>
                                    </div>
                                </form>
                            @endif
