            ...
            <li class="dropdown user user-menu">
              <a href="#" class="waves-effect waves-light dropdown-toggle w-auto l-h-12 bg-transparent p-0 no-shadow" 
                ...
                <div class="d-flex pt-1 align-items-center">
                  ...
                  <img src="{{ asset('assets/images/avatar/avatar-1.png') }}" class="avatar rounded-circle bg-primary-light h-40 w-40" alt="" />
                </div>
              </a>
            </li>
          </ul>
        ...
        <div class="multinav">
          <div class="multinav-scroll" style="height: 97%;">	
            ...
            <ul class="sidebar-menu" data-widget="tree">
              ...
              <li class="treeview">
                <a href="#">
                  <i data-feather="home"></i><span>Schools</span>
                  <span class="pull-right-container">
                    <i class="fa fa-angle-right pull-right"></i>
                  </span>
                </a>
                <ul class="treeview-menu">
                  <li><a href="{{ route('admin.schools.index') }}">All Schools</a></li>
                  <li><a href="{{ route('admin.schools.create') }}">Add New</a></li>
                </ul>
              </li>
              <li class="treeview">
                <a href="#">
                  <i data-feather="user-check"></i><span>Students</span>
                  <span class="pull-right-container">
                    <i class="fa fa-angle-right pull-right"></i>
                  </span>
                </a>
                <ul class="treeview-menu">
                  ...
                  <li><a href="{{ route('admin.students.create') }}">Add New</a></li>
                </ul>
              </li>
              <li class="treeview">
                <a href="#">
                ...
                <ul class="treeview-menu">
                  ...
                  <li><a href="{{ route('admin.subjects.create') }}">Add New</a></li>
                </ul>
              </li>
              <li class="treeview">
                <a href="#">
                  <i data-feather="book-open"></i><span>User Subjects</span>
                  <span class="pull-right-container">
                    <i class="fa fa-angle-right pull-right"></i>
                  </span>
                </a>
          ...
          <div class="modal-body p-30 bg-white">
            ...
            <div>
              <div class="d-flex flex-row">
                <div class="">
                  <img src="{{ asset('assets/images/avatar/avatar-1.png') }}" alt="user" class="rounded bg-danger-light w-150" width="100">
                </div>
                <div class="ps-20">
