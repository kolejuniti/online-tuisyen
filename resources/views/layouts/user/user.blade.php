        ...
        <div class="multinav">
          <div class="multinav-scroll" style="height: 97%;">	
            ...
            <ul class="sidebar-menu" data-widget="tree">
              ...
              <li>
                <a href="{{ route('user.summary.index', Session::get('subjects')->id) }}" class="{{ Request::is('user/summary/*') ? 'active' : '' }}"><i data-feather="archive"></i><span>Course Summary</span></a>
              </li>
              <li>
                <a href="{{ route('user.content', Session::get('subjects')->id) }}" class="{{ Request::is('/content/*') ? 'active' : '' }}"><i data-feather="airplay"></i><span>Course Content</span></a>
              </li>
              <li class="treeview">
                ...
                <li class="treeview">
                  ...
                  <ul class="treeview-menu treeview-menu-visible" id="treeview-menu-visible">
                  <li><a href="{{ route('user.quiz', Session::get('subjects')->id) }}" class="">Online</a></li>
                  <li><a href="{{ route('user.quiz2', Session::get('subjects')->id) }}" class="">Offline</a></li>
                  </ul>
                </li>
                <li class="treeview">
                  ...
                  <ul class="treeview-menu treeview-menu-visible" id="treeview-menu-visible">
                  <li><a href="{{ route('user.test', Session::get('subjects')->id) }}" class="">Online</a></li>
                  <li><a href="{{ route('user.test2', Session::get('subjects')->id) }}" class="">Offline</a></li>
                  </ul>
                </li>
              ...
              <li>
                <a href="{{ route('user.forum', Session::get('subjects')->id) }}" class="{{ Request::is('user/forum/*') ? 'active' : '' }}"><i data-feather="message-square"></i><span>Forum</span></a>
              </li>
              <li>
                <a href="{{ route('user.library', Session::get('subjects')->id) }}" class="{{ Request::is('user/library/*') ? 'active' : '' }}"><i data-feather="book"></i><span>Library</span></a>
              </li>
              <li>
                <a href="{{ route('user.online-class.index', Session::get('subjects')->id) }}" class="{{ Request::is('user/online-class/*') ? 'active' : '' }}"><i data-feather="video"></i><span>Online Class</span></a>
              </li>
            </ul>
